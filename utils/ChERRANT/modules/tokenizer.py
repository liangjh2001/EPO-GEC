...
class Tokenizer:
    ...
    def __init__(self,
        ...
        self.ltp = None 
        if granularity == "word":
            self.ltp = LTP(pretrained_model_name_or_path="LTP_small",device=torch.device(device) if torch.cuda.is_available() else torch.device("cpu"),
